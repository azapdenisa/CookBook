<?php
    ...
    if($_POST)
    {
        ...
        if ($error != ""){
            ...
            $emailTo = "deni.azap11@gmail.com";
            $subject = $_POST['subject'];
            $content = $_POST['content'];
            $headers = "From: ".$_POST['email'];

            if (mail($emailTo, $subject, $content, $headers)){
                $successMsg = '<div class="alert alert-success" role="alert">Your message was sent!</div>';
            }
            else {
                $error = '<div class="alert alert-danger" role="alert"><p><strong>Your message couldn\'t be sent. Try again later</strong></p></div>';
            }
        }
